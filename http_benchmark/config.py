...
class BenchmarkSettings(BaseSettings):
    ...
    supported_client_libraries: List[str] = ["requests", "requestx", "httpx", "aiohttp", "urllib3", "pycurl"]
    
    # Supported HTTP methods
    supported_http_methods: List[str] = ["GET", "POST", "PUT", "DELETE", "PATCH", "HEAD", "OPTIONS", "STREAM"]
